                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="celana">Bunga indonesia</option>
                                <option value="baju">Bunga filipine</option>
                                <option value="aksesoris">bunga jepang</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="Bunga mancanegara">Bunga mancanegara</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
