                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="Bunga indonesia" {{ $data->type === 'Bunga indonesia' ? 'selected' : '' }}>Bunga indonesia</option>
                                <option value="Bunga filipine" {{ $data->type === 'Bunga filipine' ? 'selected' : '' }}>Bunga filipine</option>
                                <option value="bunga jepang" {{ $data->type === 'bunga jepang' ? 'selected' : '' }}>bunga jepang
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="Bunga Mancanegara" {{ $data->kategory === 'Bunga Mancanegara' ? 'selected' : '' }}>Bunga Mancanegara</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
